...
/* AVL Bits. */
#define PTE_M 0x200            /* 1=memory mapped, 0=otherwise (PTEs only). */
#define PTE_S 0x400            /* 1=swapped out, 0=otherwise (PTEs only). */
#define PTE_E 0x800            /* 1=ELF image, 0=otherwise (PTEs only). */
